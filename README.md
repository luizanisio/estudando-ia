...
- `2025` <b> [LLMs Treinamento e Predição](https://github.com/luizanisio/llms/blob/main/README.md)</b> Alguns códigos em evolução que estou trabalhando durante o mestrado.
