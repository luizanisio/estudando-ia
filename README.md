...
- `2023` <b> Doc2VecRapido </b> uma classe que simplifica a criação de um modelo Doc2Vec sem muitos parâmetros e de forma mais simples que o [Doc2VecFacil](https://github.com/luizanisio/Doc2VecFacil), usando o framework [`Gensim 4.0.1`](https://radimrehurek.com/gensim/), veja aqui: [Doc2VecRapido](https://github.com/luizanisio/Doc2VecRapido). Veja também algumas dicas de como realizar pesquisa vetorial no [SingleStore/MemSQL](https://github.com/luizanisio/Doc2VecFacil/blob/main/docs/readme_dicas.md) e no [ElasticSearch](https://github.com/luizanisio/PesquisaElasticFacil/blob/main/docs/ElasticQueries.md).
